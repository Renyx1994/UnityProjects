...
/*SF_DATA;ver:0.34;sub:START;pass:START;ps:flbk:Reflective/Bumped Specular,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:True,lprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,rpth:0,hqsc:True,hqlp:False,blpr:0,bsrc:0,bdst:0,culm:0,dpts:2,wrdp:True,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:1,x:32344,y:32667|diff-8-OUT,spec-28-OUT,gloss-45-OUT,normal-51-RGB,transm-123-OUT,amdfl-113-OUT;n:type:ShaderForge.SFN_Tex2d,id:2,x:33024,y:32372,ptlb:Base,ptin:_Base,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:8,x:32778,y:32344|A-2-RGB,B-17-RGB;n:type:ShaderForge.SFN_Color,id:17,x:33024,y:32569,ptlb:Color Tint,ptin:_ColorTint,glob:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Multiply,id:28,x:32823,y:32646|A-35-RGB,B-29-OUT;n:type:ShaderForge.SFN_Slider,id:29,x:33197,y:32391,ptlb:Specular Level,ptin:_SpecularLevel,min:0,cur:0,max:10;n:type:ShaderForge.SFN_Tex2d,id:35,x:33197,y:32539,ptlb:Specular (RGB) Gloss (A),ptin:_SpecularRGBGlossA,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Slider,id:43,x:33179,y:32729,ptlb:Gloss Level,ptin:_GlossLevel,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Multiply,id:45,x:32823,y:32800|A-35-A,B-43-OUT;n:type:ShaderForge.SFN_Tex2d,id:51,x:32982,y:32871,ptlb:Normal Map,ptin:_NormalMap,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Fresnel,id:78,x:33323,y:32984|EXP-102-OUT;n:type:ShaderForge.SFN_Color,id:84,x:33308,y:33144,ptlb:Rim Color,ptin:_RimColor,glob:False,c1:0.9926471,c2:0.9926471,c3:0.9926471,c4:1;n:type:ShaderForge.SFN_Slider,id:102,x:33443,y:33079,ptlb:Rim Level,ptin:_RimLevel,min:0,cur:2.805166,max:10;n:type:ShaderForge.SFN_Blend,id:113,x:33102,y:33071,blmd:1,clmp:True|SRC-78-OUT,DST-84-RGB;n:type:ShaderForge.SFN_Blend,id:123,x:32633,y:33112,blmd:10,clmp:True|SRC-124-RGB,DST-125-OUT;n:type:ShaderForge.SFN_Color,id:124,x:32832,y:33037,ptlb:Transmission Color,ptin:_TransmissionColor,glob:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Fresnel,id:125,x:32834,y:33234|EXP-176-OUT;n:type:ShaderForge.SFN_NormalVector,id:153,x:32994,y:33131,pt:False;n:type:ShaderForge.SFN_Slider,id:176,x:32934,y:33352,ptlb:Transmission Fresnel,ptin:_TransmissionFresnel,min:0,cur:0.06429847,max:1;proporder:2-17-29-35-43-51-84-102-124-176;pass:END;sub:END;*/
...
/////// Normals:
                ...
                float3 normalLocal = UnpackNormal(tex2D(_NormalMap,TRANSFORM_TEX(node_190.rg, _NormalMap))).rgb;
...
/////// Diffuse:
                ...
                #endif
///////// Gloss:
                float4 node_35 = tex2D(_SpecularRGBGlossA,TRANSFORM_TEX(node_190.rg, _SpecularRGBGlossA));
...
////// Specular:
                ...
                finalColor += diffuseLight * (tex2D(_Base,TRANSFORM_TEX(node_190.rg, _Base)).rgb*_ColorTint.rgb);
                finalColor += specular;
/// Final Color:
...
/////// Normals:
                ...
                float3 normalLocal = UnpackNormal(tex2D(_NormalMap,TRANSFORM_TEX(node_191.rg, _NormalMap))).rgb;
                float3 normalDirection =  normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
...
///////// Gloss:
                float4 node_35 = tex2D(_SpecularRGBGlossA,TRANSFORM_TEX(node_191.rg, _SpecularRGBGlossA));
                float gloss = (node_35.a*_GlossLevel);
                float specPow = exp2( gloss * 10.0+1.0);
////// Specular:
                NdotL = max(0.0, NdotL);
                ...
                float3 finalColor = 0;
                float3 diffuseLight = diffuse;
                finalColor += diffuseLight * (tex2D(_Base,TRANSFORM_TEX(node_191.rg, _Base)).rgb*_ColorTint.rgb);
                finalColor += specular;
/// Final Color:
